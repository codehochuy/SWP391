 ...
 * @author PC
 */
@WebServlet(name = "BanCustomerQuotationVersion", urlPatterns = {"/BanCustomerQuotationVersion"})
public class BanCustomerQuotationVersion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean check = dao1.updateCustomerQuotationVersionStatus(0, versionId);
