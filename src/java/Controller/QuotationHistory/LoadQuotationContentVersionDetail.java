 ...
 * @author PC
 */
@WebServlet(name = "LoadQuotationContentVersionDetail", urlPatterns = {"/LoadQuotationContentVersionDetail"})
public class LoadQuotationContentVersionDetail extends HttpServlet {
