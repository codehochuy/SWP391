 ...
 * @author PC
 */
@WebServlet(name = "LoadFormChangeReponseQuotationDetail", urlPatterns = {"/LoadFormChangeReponseQuotationDetail"})
public class LoadFormChangeReponseQuotationDetail extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int selectedHouseType = (request.getParameter("houseType") != null && !request.getParameter("houseType").isEmpty()) ? Integer.parseInt(request.getParameter("houseType")) : 0;
            int selectedService = (request.getParameter("service") != null && !request.getParameter("service").isEmpty()) ? Integer.parseInt(request.getParameter("service")) : 0;
            int selectedStyle = (request.getParameter("style") != null && !request.getParameter("style").isEmpty()) ? Integer.parseInt(request.getParameter("style")) : 0;
