 ...
 * @author PC
 */
@WebServlet(name = "LoadQuotationContentVersionDetail2", urlPatterns = {"/LoadQuotationContentVersionDetail2"})
public class LoadQuotationContentVersionDetail2 extends HttpServlet {
