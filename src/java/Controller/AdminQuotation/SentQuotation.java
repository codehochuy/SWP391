 ...
 * @author PC
 */
@WebServlet(name = "SentQuotation", urlPatterns = {"/SentQuotation"})
public class SentQuotation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<CustomerRequest>list = dao.getAllSentQuotation();
