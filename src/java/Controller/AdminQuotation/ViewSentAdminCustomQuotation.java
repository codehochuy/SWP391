 ...
 * @author PC
 */
@WebServlet(name = "ViewSentAdminCustomQuotation", urlPatterns = {"/ViewSentAdminCustomQuotation"})
public class ViewSentAdminCustomQuotation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.getRequestDispatcher("WebPages/ViewManager/Page/AdminManager/viewSentAdminCustomQuotation.jsp").forward(request, response);
        }
    }
