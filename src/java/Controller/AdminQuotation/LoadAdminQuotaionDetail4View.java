 ...
 * @author PC
 */
@WebServlet(name = "LoadAdminQuotaionDetail4View", urlPatterns = {"/LoadAdminQuotaionDetail4View"})
public class LoadAdminQuotaionDetail4View extends HttpServlet {
...
//            }
            ...
            double sRoof = 0;
            //print out result
            out.println("<h4 style=\"color: white;\">Yêu cầu báo giá của khách hàng</h4>");
