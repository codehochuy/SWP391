 ...
 * @author PC
 */
@WebServlet(name = "NotSentQuotation", urlPatterns = {"/NotSentQuotation"})
public class NotSentQuotation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<CustomerRequest>list = dao.getAllNotSentQuotation();
