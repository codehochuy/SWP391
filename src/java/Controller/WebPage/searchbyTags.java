 ...
 * @author Admin
 */
@WebServlet(name = "searchbyTags", urlPatterns = {"/searchbyTags"})
public class searchbyTags extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet searchbyTags</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet searchbyTags at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
     ...
     String tagSearch = request.getParameter("tagSearch");
        BlogDAO dao = new BlogDAO();
           List<BlogDTO> blogs = dao.getAllbyTags(tagSearch);
